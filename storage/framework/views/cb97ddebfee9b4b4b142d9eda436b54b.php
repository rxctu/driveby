<?php $__env->startSection('title', 'EpiDrive - Votre épicerie de quartier, livrée chez vous en 30 min'); ?>
<?php $__env->startSection('meta_description', 'EpiDrive, votre épicerie de quartier en ligne. Fruits, légumes, produits laitiers, épicerie fine et bien plus. Livraison rapide à domicile en 30 minutes.'); ?>
    ...
    <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16"
        ...
        <div class="flex sm:grid sm:grid-cols-3 lg:grid-cols-5 gap-4 sm:gap-6 scroll-x-snap sm:overflow-visible pb-4 sm:pb-0 -mx-4 px-4 sm:mx-0 sm:px-0">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $categories ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <a href="<?php echo e(route('catalog.category', $category->slug)); ?>"
                   class="category-card flex-shrink-0 w-36 sm:w-auto bg-gradient-to-br <?php echo e($categoryColors[$index % count($categoryColors)]); ?> rounded-2xl p-6 text-center group"
                   x-show="shown"
                   x-transition.duration.500ms
                   style="transition-delay: <?php echo e($index * 80); ?>ms;">
                    <div class="emoji-icon text-center mb-3">
                        <?php echo e($categoryEmojis[$index % count($categoryEmojis)]); ?>
                    ...
                    <?php if(isset($category->products_count)): ?>
                        <span class="inline-block mt-2 text-xs bg-white/60 text-gray-600 px-2 py-0.5 rounded-full font-medium">
                            <?php echo e($category->products_count); ?> produits
                        </span>
                    <?php endif; ?>
                </a>
    ...
    <section class="py-12 sm:py-16 bg-white"
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between mb-10" x-show="shown" x-transition.duration.600ms>
                ...
                <a href="<?php echo e(route('catalog.index')); ?>" class="hidden sm:inline-flex items-center space-x-1 text-emerald-700 font-semibold hover:text-emerald-800 transition-colors duration-200">
                    <span>Tout voir</span>
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6">
                <?php $__empty_1 = true; $__currentLoopData = $featuredProducts ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="product-card bg-white rounded-2xl shadow-md overflow-hidden group"
                        ...
                        <a href="<?php echo e(route('catalog.product', [$product->category->slug, $product->slug])); ?>" class="block relative overflow-hidden aspect-square">
                        ...
                        <div class="p-4">
                            <a href="<?php echo e(route('catalog.product', [$product->category->slug, $product->slug])); ?>">
                            ...
                            <div class="flex items-center justify-between mt-3">
                                <span class="inline-flex items-center bg-emerald-100 text-emerald-800 font-extrabold px-3 py-1 rounded-xl text-lg">
                                    <?php echo e(number_format($product->price, 2, ',', ' ')); ?>&nbsp;&euro;
                                </span>
                                ...
                                <button
                                    @click="
                                        ...
                                        fetch('<?php echo e(route('cart.add')); ?>', {
                                            ...
                                            body: JSON.stringify({ product_id: <?php echo e($product->id); ?>, quantity: 1 })
                                    ...
                                    :aria-label="added ? 'Ajouté' : 'Ajouter <?php echo e($product->name); ?> au panier'">
            ...
            <div class="sm:hidden text-center mt-8">
                <a href="<?php echo e(route('catalog.index')); ?>" class="inline-flex items-center space-x-2 bg-emerald-700 text-white font-bold px-6 py-3 rounded-xl hover:bg-emerald-800 transition-all duration-200">
