<?php $__env->startSection('title', $metaTitle ?? 'Catalogue - EpiDrive'); ?>
<?php $__env->startSection('meta_description', $metaDescription ?? 'Parcourez toutes les categories de produits EpiDrive.'); ?>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14 relative">
            ...
            <nav class="mb-6">
                <ol class="flex items-center space-x-2 text-sm">
                    <li>
                        <a href="<?php echo e(route('home')); ?>" class="inline-flex items-center px-3 py-1 rounded-full bg-white/20 text-white/90 hover:bg-white/30 transition backdrop-blur-sm">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6">
            <?php $__empty_1 = true; $__currentLoopData = $categories ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <a href="<?php echo e(route('catalog.category', $category->slug)); ?>"
                   class="group relative rounded-2xl <?php echo e($pastelColors[$index % count($pastelColors)]); ?> p-6 sm:p-8 transition-all duration-300 hover:shadow-xl hover:-translate-y-2 hover:scale-[1.02] overflow-hidden"
                   style="animation: fadeInUp 0.5s ease-out <?php echo e($index * 0.08); ?>s both;">
                    ...
                    <div class="text-5xl sm:text-6xl mb-4 transform group-hover:scale-110 group-hover:rotate-6 transition-transform duration-300">
                        <?php echo e($emojiMap[$category->name] ?? $defaultEmoji); ?>

                    </div>

                    
                    <h2 class="font-bold text-gray-800 text-base sm:text-lg relative z-10"><?php echo e($category->name); ?></h2>

                    
                    <p class="text-sm text-gray-500 mt-1 relative z-10">
                        <?php echo e($category->products_count ?? 0); ?> produit<?php echo e(($category->products_count ?? 0) > 1 ? 's' : ''); ?>
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <div class="col-span-full text-center py-20">
                    <div class="text-6xl mb-4"><?php echo e($defaultEmoji); ?></div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/catalog/index.blade.php ENDPATH**/ ?>