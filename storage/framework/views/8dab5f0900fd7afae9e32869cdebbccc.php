<?php $__env->startSection('title', 'Politique de confidentialite - EpiDrive'); ?>
<?php $__env->startSection('meta_description', 'Decouvrez comment EpiDrive protege vos donnees personnelles conformement au RGPD.'); ?>
        ...
        <section>
            ...
            <p class="text-gray-600 leading-relaxed mt-4">
                <?php if(auth()->guard()->check()): ?>
                    ...
                    <a href="<?php echo e(route('account.privacy')); ?>" class="text-emerald-600 hover:underline">espace personnel</a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/legal/privacy.blade.php ENDPATH**/ ?>