        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div class="border-t border-white/10 mt-10 pt-8">
                <div class="flex flex-wrap justify-center gap-x-6 gap-y-2 text-sm text-gray-400 mb-4">
                    <a href="{{ route('legal.mentions') }}" class="hover:text-white transition">Mentions legales</a>
                    <a href="{{ route('legal.privacy') }}" class="hover:text-white transition">Politique de confidentialite</a>
                    <a href="{{ route('legal.cgv') }}" class="hover:text-white transition">CGV</a>
                    <a href="{{ route('legal.cookies') }}" class="hover:text-white transition">Politique cookies</a>
                </div>
