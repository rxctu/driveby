...
@section('title', 'Connexion - EpiDrive')
@section('meta_description', 'Connectez-vous a votre compte EpiDrive pour passer commande et suivre vos livraisons.')
            ...
            <div class="flex-1 flex items-center justify-center px-4 sm:px-8 py-8 lg:py-12">
                <div class="w-full max-w-md" x-data="{ showPassword: false }" x-init="setTimeout(() => $el.classList.remove('opacity-0', 'translate-y-4'), 50)"
                    ...
                    <p class="text-center text-sm text-gray-500 mt-6">
                        ...
                        <a href="{{ route('register') }}" class="text-emerald-600 hover:text-emerald-700 font-bold transition">Creer un compte</a>
                    </p>
                </div>
            </div>
        </div>
